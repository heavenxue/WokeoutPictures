...
public class DefaultImageSizeCalculator implements ImageSizeCalculator{
    ...
    @Override
    public MaxSize caculateImageMaxSize(SketchImageViewInterface sketchImageViewInterface) {
    ...
    @Override
    public ReSize caculateImageReSize(SketchImageViewInterface sketchImageViewInterface) {
        View imageView = sketchImageViewInterface.getSelf();
        if(imageView == null){
            return null;
        }
    ...
    @Override
    public FixedSize caculateImageFixedSize(SketchImageViewInterface sketchImageViewInterface) {
        View imageView = sketchImageViewInterface.getSelf();
        if(imageView == null){
            return null;
        }
